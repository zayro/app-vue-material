  ...
  <div class="centered-container">
    <md-content class="md-elevation-3">
      ...
      <div class="actions md-layout md-alignment-center-space-between">
        <router-link to="/recovery">Reset password</router-link>
...
<script>
import { http, axioService } from "../services";
...
export default {
  ...
  mounted() {
    ...
    http
      .get("https://jsonplaceholder.typicode.com/todos/1", this.form)
      ...
      axioService.getAll().then(function (response) {
        console.log(response.data);
        if (response.data.status == true) {
          swal({
            title: "Datos Enviados",
